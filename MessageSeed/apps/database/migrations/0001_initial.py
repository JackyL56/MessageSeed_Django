    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_time', models.DecimalField(decimal_places=3, default=Decimal('1671454279976.072998046875'), max_digits=20, verbose_name='Time of Death for the message.')),
                ('death_time', models.DecimalField(decimal_places=3, default=Decimal('1672059079976.072998046875'), max_digits=20, verbose_name='Time of Death for the message.')),
                ...
                ('user_likes', models.ManyToManyField(blank=True, help_text='List of Users who have liked this message.', related_name='user_likes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'message',
                'verbose_name_plural': 'messages',
                'ordering': ['post_time', 'author'],
            },
        ),
    ]
